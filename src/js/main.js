...
document.addEventListener('DOMContentLoaded', function(){
	...
	**/
	...
	if (showAddWindow) {
		[].forEach.call(showAddWindow, function (el) {
			el.addEventListener("click", function (e) {
				e.preventDefault();
			...
			function (el) {
				el.addEventListener("click", function (e) {
					...
					if (this.classList.contains("selector--tab")) {
						let othersTabs =
							this.closest(".tabs").querySelectorAll(".selector");
	...
	**/
	...
	let selectCustom = function () {
		let selectHeader = document.querySelectorAll(".select-cstm__header");
		let selectItem = document.querySelectorAll(".select-cstm__item");
		...
		function selectChoose() {
			let text = this.innerHTML,
				...
				select = this.closest(".select-cstm"),
				input = select.querySelector("input[type=hidden]"),
				currentText = select.querySelector(".select-cstm__current");
